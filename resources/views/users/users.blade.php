                ...
                <div class="student-inner-std res-mg-b-30">
                    ...
                    <div class="student-dtl ">
                        ...
                        <div class="col-sm-12 text-center" style="padding: 15px;">
                            ...
                            <p class="dp col-sm-12">{{$user->userFullName}}</p>
                            <p class="dp col-sm-12">{{$user->role->roleName}}</p>
                            <p class="dp col-sm-12">{{$user->branch->branchName}}</p>
                            
                        </div>

                        <br />
                        <div class="product-buttons text-center ">
                            <a href="{{route('user.show' ,$user->id)}}"><button data-toggle="tooltip" title="View"
                                class="pd-setting-ed"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                       


                        <a href="{{route('user.edit' , $user->id)}}"><button data-toggle="tooltip" title="Edit"
                                class="pd-setting-ed"><i class="fa fa-pencil-square-o"
                                    aria-hidden="true"></i></button></a>

                            
                        <button data-toggle="modal" data-target="#del{{$user->id}}" title="Trash"
                            ...
                            <div id="del{{$user->id}}" class="modal modal-edu-general fullwidth-popup-InformationproModal fade" role="dialog">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="student-inner-std res-mg-b-30">
                                    <h2> There is no user Data Entered yet </h2>
                                </div>
                            </div>
