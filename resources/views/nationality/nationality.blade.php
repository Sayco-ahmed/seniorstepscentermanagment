            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-left">
                <ul class="breadcome-menu pull-left" style="direction: ltr;">
                  ...
                  <li>
                    <span class="bread-blod"> Nationalities </span>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="sparkline13-list">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <h3 style="text-align:left">nationality Data</h3>
                            <button data-toggle="modal" data-target="#addnationality" data-whatever="@mdo" class="btn_add_item">Add nationality</button>


                                    <!-- بداية جزء الموديل الخاص باضافة المدينه -->
                            <div class="modal fade" id="addnationality" tabindex="-1" role="dialog" aria-labelledby="addnationalityLabel">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                      <h4 class="modal-title" id="addnationalityLabel">New Nationality</h4>
                                    </div>
                                    <form action="{{url('nationality')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        {{ method_field('POST') }}
                                    <div class="modal-body"> 
                                            ...
                                            <div class="form-group">
                                                <label for="nationality-name" class="control-label">nationality name:</label>
                                            <input type="text" class="form-control" id="nationality-name" name="nationalityName" value="{{old('nationalityName')}}">
                                            </div>
                            ...
                            <table class="table-striped" id="table" data-toggle="table" data-pagination="true"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($nationality as $nationality)
                                        ...
                                        {{-- <td>{{ $nationality->countryId }}</td> --}}
                                        <td>
                                            <div class="product-buttons">
                                                <button  data-toggle="modal" data-target="#edtnationality{{ $nationality->id }}" data-whatever="@mdo"
                                                    class="pd-setting-ed"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></button>
                                                
                                                <button data-toggle="modal" data-target="#del{{ $nationality->id }}" title="Trash"
                                    ...
                                    <div class="modal fade" id="edtnationality{{ $nationality->id }}" tabindex="-1" role="dialog" aria-labelledby="addnationalityLabel">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                              <h4 class="modal-title" id="addnationalityLabel">Edit nationality</h4>
                                            </div>
        
                                            <form action="{{route('nationality.update' , $nationality->id )}}" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    {{ method_field('put') }}
                                                <div class="modal-body">
                                                    ...
                                                    {{-- <div class="form-group">
                                                    <label for="nationality-id" class="control-label">nationality ID:</label>
                                                    <input type="text" class="form-control" id="nationality-id">
                                                    </div> --}}
                                                    <div class="form-group">
                                                    
                                                        <label for="nationality-name" class="control-label">nationality name:</label>
                                                        <input type="text" class="form-control" id="nationality-name" name="nationalityName" value="{{ $nationality->nationalityName }}">
                                                    </div>
                                    ...
                                    <script>
                                      ...
                                      $('#addnationality').on('show.bs.modal', function (event) {
                                      ...
                                      $('#edtnationality'{{ $nationality->id }}).on('show.bs.modal', function (event) {
                                        var button = $(event.relatedTarget) // Button that triggered the modal
                                        var recipient = button.data('whatever') // Extract info from data-* attributes
                                        // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
                                        // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
                                    ...
                                    <div id="del{{ $nationality->id }}" class="modal modal-edu-general fullwidth-popup-InformationproModal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header header-color-modal bg-color-2">
                                                    <h4 class="modal-title" style="text-align:left">Delete nationality</h4>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <h2>{{ $nationality->nationalityName }}</h2>
                                                    <h4>Do you want to delete this nationality</h4>
                                                </div>
                                                <div class="modal-footer info-md">
                                                    <form action="{{route('nationality.destroy',$nationality->id)}}" method="post" style="display: inline-block">
                                                        {{csrf_field()}}
                                                        {{method_field('delete')}}
