						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="header-top-wraper">
								<div class="row">
									...
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right" style="direction: rtl;">
											...
											<ul class="nav navbar-nav mai-top-nav header-right-menu">
															...
															<li>
																<a href="#">
																	...
																	<div class="message-content">
																		<span class="message-date">16 april</span>
																		<h2>Ahmed Sayed </h2>
																		<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. At itaque commodi praesentium</p>
																	</div>
																</a>
															</li>
															<li>
												...
												<li class="nav-item">
													<a href="#" data-toggle="dropdown" role="button"
														...
														<span class="admin-name">Sara AbdelRahman</span>
													...
													<ul role="menu"
														...
														<li>
															<a href="User_profile.html"><span
																	class="edu-icon edu-home-admin author-log-ic"></span>User Profile</a>
														</li>
														<li>
															<a href="#"><span
