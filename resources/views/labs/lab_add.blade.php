                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-left">
                            <ul class="breadcome-menu pull-left" style="direction: ltr;">
                                ...
                                <li>
                                    <span class="bread-blod"> Add lab </span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="sparkline16-list responsive-mg-b-30">
                        <div class="profile-img mg-b-23">
                            <img src="{{asset('uploads/lab/default_lab.png')}}" alt="" class="image-preview" />
                        </div>
                        <div class="file-upload-inner ts-forms mg-b-15">
                            <div class="input prepend-big-btn">
                                ...
                                <input type="file" name="labImg"  value="{{old('labImg')}}" class="image" >
                                </div>
                        ...
                        <div class="sparkline16-graph">
                            <div class="date-picker-inner" style="text-align:left">
                                ...
                                <div class="form-group data-custon-pick" style="text-align:left">
                                    ...
                                    <div class="input-mark-inner mg-b-22">
                                    <input type="number" name="labNumber" class="form-control" placeholder="lab number" value="{{old('labNumber')}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group data-custon-pick" style="text-align:left">
                                    ...
                                    <div class="input-mark-inner mg-b-22">
                                    <input type="number" name="pcsNumber" class="form-control" placeholder="PCs Number" value="{{old('pcsNumber')}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group data-custon-pick" style="text-align:left">
                                    ...
                                    <div class="input-mark-inner mg-b-22">
                                    <input type="number" name="chairsNumber" class="form-control" placeholder="Chairs Number" value="{{old('chairsNumber')}}">
                                    </div>
                                </div>
                                <div class="form-group data-custon-pick" style="text-align:left">
                                    <label>Additive Chairs</label>
                                    <div class="input-mark-inner mg-b-22">
                                        <input type="number" name="additiveChairs" class="form-control" placeholder="Additive Chairs" value="{{old('additiveChairs')}} " >
                                    </div>
                                </div>
                                <div class="form-group data-custon-pick" style="text-align:left">
                                    <label>Notes</label>
                                    <div class="input-mark-inner mg-b-22">
                                        ...
                                        <textarea class="form-control" placeholder="enter notes" name="notes"> {{old('notes')}} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
